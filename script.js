...
function setupLanguageSwitcher() {
  ...
  const translations = {
    tr: {
      ...
      "team.finance.title": "Finans Başkanı",
    ...
    en: {
      ...
      "team.admin.text": "Başak Begüm Ateş serves as the Admin Head in the Liberte G20 event. Her duty is to lead and assist admins who will ensure administrative order within the committee, support delegates, and ensure the sessions progress smoothly.",
      "team.saha.name": "Baran Eren Bayraktutar & Yaren Yılmaz",
      ...
      "team.finance.name": "Hanife Gören",
      "team.finance.title": "Finance Head",
    ...
    fr: {
      ...
      "team.admin.text": "Başak Begüm Ateş est la responsable administrative de l'événement Liberte G20. Son devoir est de diriger et d'assister les administrateurs qui assureront l'ordre administratif au sein du comité.",
      "team.saha.name": "Baran Eren Bayraktutar & Yaren Yılmaz",
      ...
      "team.finance.name": "Hanife Gören",
      "team.finance.title": "Responsable des Finances",
    ...
    de: {
      ...
      "team.admin.text": "Başak Begüm Ateş ist die Admin-Leiterin beim Liberte G20 Event. Ihre Aufgabe ist es, die Admins zu leiten, die die Ordnung im Komitee gewährleisten.",
      "team.saha.name": "Baran Eren Bayraktutar & Yaren Yılmaz",
      ...
      "team.member10.name": "Ahmet Tarık Kabasakal",
      "team.member10.title": "Krisenleiter",
